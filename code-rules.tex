...
\section*{1. Consider your threat model}\label{s:threat-model}
...
\item
  ...
  \end{enumerate}
  Section~\ref{s:quickly} explores alternatives,
...
\item
  ...
  Section~\ref{s:succession} discusses ways to plan for this.
...
\section*{2. Stay within the law}\label{s:legal}
...
\section*{3. Choose an open license}\label{s:license}
...
\section*{4. Save everything in multiple places}\label{s:lockss}
...
and as noted in Section~\ref{s:community},
...
\section*{5. Encourage community adoption}\label{s:community}
...
\section*{6. Do what you're supposed to (if you have time)}\label{s:properly}
...
\section*{7. Do what you can (if you have to act quickly)}\label{s:quickly}
...
\section*{8. Write a succession plan}\label{s:succession}
...
\section*{9. Talk about what you're doing}\label{s:talk}
