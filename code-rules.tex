...
Repositories can be altered, deleted, or made private;
the platform itself may be shut down %(example of Gna! - https://en.wikipedia.org/wiki/Gna!)
or change its revenue model.  %(example of SF.net - https://en.wikipedia.org/wiki/SourceForge)
