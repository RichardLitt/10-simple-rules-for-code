...
\textbf{YBS} rOpenSci, Argentina, \orcid{0000-0002-4522-7466}\\
...
\textbf{EAO} \orcid{0000-0003-1800-9268}\\
\textbf{MWM} \orcid{0000-0001-6010-7561}\\
...
When setting these up, it is important to ensure that control over the
distribution channels for a package is not limited to a single developer.
