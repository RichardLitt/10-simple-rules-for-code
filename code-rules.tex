...
Consider the following augmented Software Lifecycle (SLDC)~\ref{fig:tip3}, that is based on~\cite{deRSE25} and modified for this paper.

\begin{figure}
\includegraphics{"Lifewcycle diagram 2.pdf"}~\label{fig:tip3}
\caption{Augmented Software Lifecycle}
\end{figure}
