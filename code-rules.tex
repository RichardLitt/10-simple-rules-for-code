...
Consider the following augmented Software Lifecycle (SLDC)~\ref{fig1}, that is based on~\cite{deRSE25} and modified for this paper.

\begin{figure}
\includegraphics{Fig1.tiff}~\label{fig1}
