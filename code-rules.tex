...
\\
% \input{contributors}
Organized by Richard Littauer: see \texttt{contributors.tex} for all contributors to date.
\end{flushleft}

\section*{Abstract}

In open source, there is always a risk that a project will lose its maintainers,
with the grimly named "bus factor" typically described as a risk factor.
But this has always been meant to describe more situations than the core
developer or maintainer literally being hit by a bus. For example,
the maintainer may have to step away due to illness, to care
for another such as a newborn, from burnout, or from a lack of financial
support. In today's climate, political or financial changes are
putting relatively large numbers of developers and maintainers out of work,
pontentially leaving the software they have worked on abandoned.
In this article, we present ten tips to help researchers ensure that
...
consider working with a fiscal sponsor such as
...
your project can take donations from its community to fund continued maintenance and other costs.
...
\section*{Tip 4: Choose an open license}
...
As Putnam \cite{Putnam2020} points out,
...
a professor of epidemiology or an anti-vax conspiracy theorist?
